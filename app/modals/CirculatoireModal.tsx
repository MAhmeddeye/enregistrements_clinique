...
import { CouleurPeauType, EtatPeauType, HydratationPeauType, PoulsStatus, RemplissageCapillaireType, RythmeCardiaqueType, TemperaturePeauType } from "@/lib/types";
import { Picker } from "@react-native-picker/picker";
import { useState } from "react";

export const CirculatoireModal = ({
  visible,
  onClose,
  form,
  setForm
          ...
          <ScrollView style={styles.modalContent} showsVerticalScrollIndicator={false}>
            ...
            >
              <View style={styles.sectionTitleContainer}>
                <MaterialCommunityIcons name="skin" size={20} color="#3B82F6" />
